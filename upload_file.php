...
//if (!class_exists("Symfony\Component\DomCrawler\Crawler")) include_once(__DIR__."/vendor/symfony/dom-crawler/Crawler.php");
//include_once(__DIR__."/vendor/symfony/dom-crawler/Crawler.php");

//namespace Panorama;

//use Crawler;
//use \Symfony as Symfony;
//use \Crawler as Crawler;
